...
description 'object for sequence diagram', ->
    beforeEach -> before()
    # object
    it "should have an attr uml:type", ->
        obj_a.attr("uml:type").shouldBe ".object"
    ...
    # interaction
    it "should have an attr uml:type", ->
        iact_a.attr("uml:type").shouldBe ".interaction"
    ...
    # occurrence
    it "should have an attr uml:type", ->
        occurr_a.attr("uml:type").shouldBe ".occurrence"
    it "should have an attr uml:type", ->
        occurr_b.attr("uml:type").shouldBe ".occurrence"
    ...
    # message
    it "should have an attr uml:type", ->
        diag.find(".message").attr("uml:type").shouldBe ".message"
    ...
    # fragment
    it "should have an attr uml:type", ->
        diag.$0(".fragment").attr("uml:type").shouldBe ".fragment"
    ...
    # ref
    it "should have an attr uml:type", ->
        $.uml(".ref").attr("uml:type").shouldBe ".ref"
    ...
    # diag.am
    it "should have an attr uml:type", ->
        diag.attr("uml:type").shouldBe ".sequence-diagram"
