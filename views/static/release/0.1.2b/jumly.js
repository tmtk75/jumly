//JUMLY v0.1.2b-beta, 2011-2013 copyright(c), all rights reserved Tomotaka Sakuma. build Wed, 09 Jan 2013 03:29:30 GMT
(function() {
  var JUMLY, SCRIPT_TYPE_PATTERN, core, exported, _compilers, _evalHTMLScriptElement, _layouts, _runScripts, _to_type_string,
...
(function() {
  var HTMLElement, SequenceInteraction, SequenceOccurrence, SequenceParticipant, core,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
(function() {
  var HTMLElement, NoteElement, core,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
(function() {
  var DiagramBuilder, NoteElement, SequenceDiagram, SequenceDiagramBuilder, SequenceParticipant, core,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  SequenceDiagramBuilder.prototype._fragment = function(last, opts, desc) {
    var SequenceFragment, frag, kids, newones;
...
(function() {
  var DiagramLayout, HTMLElementLayout, SequenceDiagramLayout, SequenceLifeline, core, _,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
