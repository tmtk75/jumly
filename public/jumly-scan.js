...
(function() {
  var _placer, _provider;

  JUMLY._compile = function(code) {
    var builder;
  ...
  */
  ...
  _provider = function() {
    return $("body").find("*[data-jumly]");
  };

  JUMLY.scan = function(placer, provider) {
    if (placer == null) {
      placer = _placer;
    }
    if (provider == null) {
    ...
    return provider().each(function(i, e) {
      var $e;

      $e = $(e);
      if ($e.data("jumly.diagram")) {
        return;
      }
      return JUMLY["eval"]($e, placer($e));
    });
  };
